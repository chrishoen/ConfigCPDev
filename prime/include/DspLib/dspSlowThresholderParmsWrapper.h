...
/*==============================================================================
Dsp namespace: 
Wrapper for parameters class whose values are read from a command file. 
==============================================================================*/
...
class SlowThresholderParmsWrapper : public Ris::BaseCmdLineParms
{
public:
   ...
   SlowThresholderParmsWrapper();
   SlowThresholderParmsWrapper(SlowThresholderParms* aParms);
