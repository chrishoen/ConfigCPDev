...
public:
   ...
   // lines. Return true if successful. This is for file mode1, zip.
   bool doWrite1(
   ...
   // Read from the gcode file. Write to the script file. For each input line
   // from the gcode file, write a corresponding set of script file output
   // lines. Return true if successful. This is for file mode2, gcode.
   bool doWrite2(
      const std::string& aGCodeFilePath,           // Input
      const std::string& aScriptFilePath);         // Output
   ...
   // If the input gcode line is for an lcd image then write the corresponding
   // commands to the output script file and return true.
   bool tryLineFor_Slice2(std::string& aGCodeLine);
   ...
   // commands to the output script file and return true.
   bool tryLineFor_CMarker(std::string& aGCodeLine);
